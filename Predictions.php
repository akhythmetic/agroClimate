...
<body>
    ...
    <section class="prediction-section">
        ...
        <p>Le modèle XGBoost utilisé dans cette étude s'avère particulièrement puissant pour prédire le rendement agricole en fonction de variables clés telles que l'impact économique, la température moyenne et les émissions de CO₂. Avec un R² de 0.63, il explique une grande partie de la variabilité du rendement, ce qui montre que ces facteurs ont un lien significatif avec la productivité agricole. L’erreur absolue moyenne (MAE) de 0.50 tonnes par hectare confirme la précision du modèle, malgré la complexité et les incertitudes inhérentes au domaine agricole. Cependant, 37 % de la variabilité du rendement reste inexpliquée, soulignant l'importance de facteurs supplémentaires comme les pratiques agricoles ou les conditions locales. Cette précision relative montre que XGBoost est un outil prometteur pour les prévisions agricoles, mais qu'il pourrait être amélioré en intégrant d'autres variables. Les performances du modèle offrent ainsi une base solide pour la prise de décision, en particulier pour la planification des cultures et l’adaptation au changement climatique, tout en restant conscient des limites du modèle dans des contextes agricoles diversifiés. Ces résultats sont un premier pas vers des applications pratiques, mais des ajustements et des données supplémentaires pourraient encore améliorer la fiabilité des prédictions.</p>
    </section>
